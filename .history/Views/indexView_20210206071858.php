            ...
            <!-- fin caroussel -->
                ...
                <div class="container">
                    <div id="menu1" class="containerMot" >
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="title" id="title1"><img class="img" src="Publics/images/FR-wp1.jpg" alt="FR-wp1.jpg"></div>  
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div id="menu2">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="title" id="title2"><img class="img" src="Publics/images/feature-img5.jpg" alt=""></div>  
                            </div>
                            <!-- <div class="col-md-4">
                                <div class="title" id="title3"><img class=" imgMot" src="Publics/images/feature-img1.jpg" alt=""></div>  
                            </div> -->
                            <div class="col-md-5 col-md-offset-1">
                                <div class="title" id="title4"><img class="img" src="Publics/images/feature-img5.jpg" alt=""></div>  
                            </div>
