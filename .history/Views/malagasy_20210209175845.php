...
<head>
    ...
    <?php 
        Controllers::includeCSS(["bootstrap.min","all","brands","sweetalert2.min","util","general"]);
    ?>
</head>
<body>
    <?php 
...
///////////////////////////////////*********************////////////////////////////////
    ...
    <?php 
        Controllers::includeJS(["jquery","sweetalert2.min","all","bootstrap","brands.min","form-plugin"]);
    ?>
</body>
</html>