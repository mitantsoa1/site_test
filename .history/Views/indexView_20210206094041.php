                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 text-center">
                                    ...
                                    <h3 class="title-3">Vous avez des questions, ou bien vous voulez travailler avec nous? <br> Contactez-nous via le formulaire ci-dessous !</h3>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    <p id="name-help-block" class="help-block">Veuillez mettre votre nom</p>
                                                    <input class="form-control champ" id="name" type="text">
                                                </div>
                                                <div class="form-group">
                                                    <p id="email-help-block" class="help-block">Veuillez mettre votre adresse email</p>
                                                    <input class="form-control champ" id="email" type="text">
                                                </div>
                                                <div class="form-group">
                                                    <p id="phone-help-block" class="help-block">Veuillez mettre votre numero de téléphone</p>
                                                    <input class="form-control champ" id="phone" type="text">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    <p id="content-help-block" class="help-block">Veuillez mettre le contenu de votre message</p>
                                                    <textarea class="form-control champ" id="content"></textarea>			                    
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
