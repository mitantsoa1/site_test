            ...
            <!-- fin caroussel -->
                ...
                <div class="container">
                    ...
                    <div id="menu2">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="titleimg" id="title2"><img class="img" src="Publics/images/feature-img5.jpg" alt=""></div>  
                            </div>
                            <!-- <div class="col-md-4">
                    ...
                    <div id="menu3"  class="containerVision">
                        ...
                        <div class="row">
                                <div class="col-md-4">
                                    <div class="titleimg" id="title5"><img class="imgMot" src="Publics/image/slider-1.jpg" alt=""></div>  
                                </div>
                                <div class="col-md-4">
