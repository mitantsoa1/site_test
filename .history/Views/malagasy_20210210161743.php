            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" id="form_malagasy" enctype="multipart/form-data">
                            <?php 
                                Controllers::includeTemplate("form_publication.php");
                            ?>
                            <button name="btnPMlg" id="btn_publier_malagasy" class="btn btn-primary text-center col-sm-offset-2 col-sm-2 ">Publier</button>
                        </form>
                    </div>
