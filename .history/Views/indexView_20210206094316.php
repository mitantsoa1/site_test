                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    <p id="name-help-block" class="help-block">Votre nom</p>
                                                    <input class="form-control champ" id="name" type="text">
                                                </div>
                                                <div class="form-group">
                                                    <p id="email-help-block" class="help-block">Votre adresse email</p>
                                                    <input class="form-control champ" id="email" type="text">
                                                </div>
                                                <div class="form-group">
                                                    <p id="phone-help-block" class="help-block">Votre numero de téléphone</p>
                                                    <input class="form-control champ" id="phone" type="text">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    <p id="content-help-block" class="help-block">Contenu de votre message</p>
