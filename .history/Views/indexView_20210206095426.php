					...
					<div class="col-sm-4 col-md-4 copyright">
						<div class="info">
							<a href="#id">
								...
								<span class="legend">Lot IIA 80 C Ampandrana</span>
							</a>
						</div>
						<div class="info">
							<a href="mailto:niryinfo@gmail.com">
								<span class="icon">
									<i class="fas fa-envelope"></i>
								</span>
								<span class="legend">niryinfo@gmail.com</span>
							</a>
						</div>
						<div class="info">
							<a href="#id">
								...
								<span class="legend">+261 34 70 840 46</span>
							</a>
						</div>
						<div class="info">
							<ul class="social-buttons">
								<li class="text-center">
									<a href="https://twitter.com/info_nir" target="_blank">
										<i class="fa fa-twitter"></i>
									</a>
								</li>
								<li class="text-center">
									<a href="https://facebook.com/Niry.info" target="_blank">
										<i class="fa fa-facebook"></i>
									</a>
								</li>
								<li class="text-center">
									<a href="https://www.linkedin.com/company/nir-info" target="_blank">
										<i class="fa fa-linkedin"></i>
									</a>
								</li>
								<li class="text-center">
									<a href="https://youtube.com/channel/UCpyKeBj2hMoN1s7YZZOF2mQ" target="_blank">
