        ...
        <header class="header">
            <div class="container">
                ...
                <nav class="menu">
                    ...
                    <ul class="menu_d">
                        <li>
                            <a href="connecter" id="btn_connecter_header" data-toggle="modal" data-target="#myModal">Se connecter</a>
                        </li>
            ...
            <!-- fin caroussel -->
                ...
                <div class="container-fluid content">
                    <div id="menu1" class="containerMot" >
                            <h2 class="text-center" id="mot">A propos </h2>
                        <div class="row">
                            <div class="col-sm-5">
  ...
  <div class="modal-dialog">
    ...
    <form id="form-connexion">
        ...
        <div class="text-center">
            <a href="connecter" id="btn_connectere" class="btn btn-primary">Se connecter</a>
