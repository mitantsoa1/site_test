            ...
            <div id="monCarousel" class="carousel slide" data-ride="carousel" style="height:500px;">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img class="img-fluid" src="Publics/images/CA-wp1" alt="" style="width:100%;height:500px;" >
                    ...
                    <div class="item ">
                        <img class="img-fluid" src="Publics/images/CA-wp2" alt="" style="width:100%;height:500px;" >
                        <div class="carousel-caption">
                            <h4>IMAGE2</h4>
                        </div>
                    </div>
                    ...
                    <div class="item ">
                        <img class="img-fluid" src="Publics/images/CA-wp3" alt="" style="width:100%;height:500px;" >
                        <div class="carousel-caption">
                            <h4>IMAGE3</h4>
                        </div>
                    </div>
                    ...
                    <div class="item ">
                        <img class="img-fluid" src="Publics/images/CA-wp4" alt="" style="width:100%;height:500px;">
                        <div class="carousel-caption">
                            <h4>IMAGE4</h4>
                        </div>
                    </div>
