...
<head>
    ...
    <title>sympa</title>
    <?php
Controllers::includeCss(["bootstrap.min", "all","util","indexView","brands.min","formIndexview"]);
?>
        ...
        <header class="header">
            <div class="container">
                ...
                <nav class="menu">
                    ...
                    <ul class="menu_d">
                        <li>
                            <a href="#" id="btn_connecter_header" data-toggle="modal" data-target="#myModal">Se connecter</a>
                        </li>
  ...
  <div class="modal-dialog">
    ...
    <form id="form-connexion">
        ...
        <div class="text-center">
            <a href="#" id="btn_connecter" data-dismiss="modal" class="btn btn-primary">Se connecter</a>
             <a href="inscrire" id="btn_inscrire" class="btn btn-success">S'inscrire</a>
        </div>
...
<!-- fin modal -->
    <?php
Controllers::includeJS(["jquery", "bootstrap", "all", "form-plugin", "indexView","sweetalert2.min"]);
?>
<!-- <script>
