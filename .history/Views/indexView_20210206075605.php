            ...
            <!-- fin caroussel -->
                ...
                <div class="container">
                    ...
                    <div id="menu2">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="titleimg" id="title2"><img class="img" src="Publics/images/FR-wp2" alt="FR-wp"></div>  
                            </div>
                            <!-- <div class="col-md-4">
                                <div class="title" id="title3"><img class=" imgMot" src="Publics/images/feature-img1.jpg" alt=""></div>  
                            </div> -->
                            <div class="col-sm-5 col-md-offset-1">
                                <div class="title" id="title4"><img class="img" src="Publics/images/FR-wp3" alt="FR-wp"></div>  
                            </div>
                    ...
                    <div id="menu3"  class="containerVision">
                        ...
                        <div class="row">
                                <div class="col-sm-4">
                                    <div class="titleimg" id="title5"><img class="imgMot" src="Publics/image/FR-wp4" alt="FR-wp"></div>  
                                </div>
                                <div class="col-sm-4">
