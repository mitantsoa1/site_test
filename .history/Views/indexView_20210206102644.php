                ...
                <div class="container-fluid content">
                    ...
                    <div id="copyright">
                        <div id="info">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-4 col-md-4 col-sm-offset-1 col-md-offset-1 copyright">
                                        <div class="info">
                                        <span class="icon">
                                    ...
                                    <div class="col-sm-4 col-md-4 col-sm-offset-1 col-md-offset-1 ">
                                            <ul class="social-buttons">
                                                    <a href="https://twitter.com/montwitt" target="_blank">
                                                        <i class="fas fa-twitter"></i>
                                                    </a><a href="https://facebook.com/monFB" target="_blank">
                                                        <i class="fa fa-facebook"></i>
                                                    </a><a href="https://www.linkedin.com/monLK" target="_blank">
