...
function selectionAll() {
    ...
    s.sendInfo("Publier/selectAllPub", function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            $('.adresse_content').html(table + "<div class= '" + data[i].categorie + "'> <table class= '" + data[i].categorie + "'><tr><td>" + data[i].titre + "</td><td>" + data[i].contenu + "</td><td>" + data[i].photo + "</td><td>" + data[i].date + "</td>></tr></table></div>");
        }
    });
