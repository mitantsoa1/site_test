...
function selectionAll() {
    ...
    s.sendInfo("Publier/selectAllPub", function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            $('.adresse_content').html("<table style='background: red;' class= '" + data[i].categorie + "'><tr><td>" + data[i].date + "</td></tr><tr><td>" + data[i].titre + "</td></tr><tr><td>" + data[i].contenu + "</td></tr><tr><td>" + data[i].photo + "</td>></tr></table><br>");
        }
    });
