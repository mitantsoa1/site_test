...
function selectionAll() {
    ...
    s.sendInfo("Publier/selectAllPub", function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            $('.adresse_content').html(table + "<div class= '" + data[i].categorie + "'><table ' class= '" + data[i].categorie + "'><tr><td>" + data[i].categorie + "</td></tr><tr><td><tr><td>" + data[i].date + "</td></tr><tr><td>" + data[i].titre + "</td></tr><tr><td>" + data[i].contenu + "</td></tr><tr><td><img src='Publics/images/" + data[i].photo + "'></td>></tr></table></div><br>");
        }
    });
